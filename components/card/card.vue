<template>
	<view class="bg-white margin-top-xs padding" style="width: 100%;">
		...
		<view class="flex">
			...
			<view class="margin-left-xs padding-top-xs">
				...
				<view class="flex align-center">
					<view class="text-black" style="font-weight: 600">APEX</view>
				</view>
				<!-- 时间 -->
				<view class="margin-top-xs">
					<view class="u-light-color text-sm">2021/7/21 21:57</view>
				</view>
			</view>
		</view>
		<!-- 文字栏 -->
		<view class="margin-tb-sm clamp">
		...
		<u-tag :text="'江西师范大学'" shape="circle" color="#A8A8A8" bg-color="#F5F5F5" border-color="#F5F5F5"/>
		<!-- 底部交互栏 -->
